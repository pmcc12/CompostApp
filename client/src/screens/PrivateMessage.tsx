  ...
  useEffect(() => {
    ...
    if (!dataFetched) {
      ...
      const allChatMessages = ApiService.getAllChatMessages(+inboxId)
        .then((data: any) => setMyChatMessages(data))
        .then(() => {
        ...
        .then(() => {
          console.log(
            'setting load to true (needs to be the last one to avoid re-rendering)'
          );
                            ...
                            <Row>
                              ...
                              <Col xs={7} md={5} lg={5}>
                                <Chatbubble
                                  ...
                                  messageUsername={message.senderName}
                                  messageSenderId={message.senderId}
                                  messageDate={message.createAt}
                                />
                              </Col>
                            </Row>
                          );
                      ...
                      <Row>
                        ...
                        <Col xs={7} md={5} lg={5}>
                          <Chatbubble
                            ...
                            messageUsername={myState.data.username}
